...
const PROD_URL = "https://movement.market";
...
export const GOOGLE_PLAY_URL =
  "https://play.google.com/store/apps/details?id=meme.movement.app";
export const APPLE_URL =
  "https://apps.apple.com/us/app/movement-market/id6476886584";

const DOWNLOAD_URL = "https://movement.market/download";

export const constants = {
  environment: __DEV__ ? "development" : "production",
  apiUrl: API_URL,
  appStoreUrl: DOWNLOAD_URL,
  deeplinkUrl: "movement://",
  sentryDsnUrl:
