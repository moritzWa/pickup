...
export class swapStatus1707879843227 implements MigrationInterface {
    name = "swapStatus1707879843227";
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."swap_status_enum" AS ENUM('pending', 'confirmed', 'finalized', 'failed', 'processed')`
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TYPE "public"."swap_status_enum_old" AS ENUM('confirmed', 'failed', 'finalized', 'pending')`
        );
        await queryRunner.query(
