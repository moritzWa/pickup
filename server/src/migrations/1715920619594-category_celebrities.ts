...
export class categoryCelebrities1715920619594 implements MigrationInterface {
    name = 'categoryCelebrities1715920619594'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."category_enum" AS ENUM('united_nations', 'politics', 'religion', 'celebrities')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "category_entries" DROP CONSTRAINT "category_entry_token_idx"`);
        await queryRunner.query(`CREATE TYPE "public"."category_enum_old" AS ENUM('united_nations', 'politics', 'religion')`);
