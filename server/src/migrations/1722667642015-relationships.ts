...
export class Relationships1722667642015 implements MigrationInterface {
    name = "Relationships1722667642015";

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "relationships" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "from_user_id" uuid NOT NULL, "to_user_id" uuid NOT NULL, CONSTRAINT "relationships_idx" UNIQUE ("from_user_id", "to_user_id"), CONSTRAINT "PK_ba20e2f5cf487408e08e4dcecaf" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
            `CREATE INDEX "from_user_id_idx" ON "relationships" ("from_user_id") `
        );
        await queryRunner.query(
            `CREATE INDEX "to_user_id_idx" ON "relationships" ("to_user_id") `
        );
        await queryRunner.query(
