...
export class categoriesAndWarmer1717342260059 implements MigrationInterface {
    name = 'categoriesAndWarmer1717342260059'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."category_enum" AS ENUM('united_nations', 'politics', 'religion', 'celebrities', 'athletes', 'corporations', 'executives', 'dogs', 'cats', 'media', 'sports', 'influencers', 'actors', 'birds', 'rappers', 'characters', 'trump', 'presidential_candidates_twenty_four', 'bonk', 'memes')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "category_entries" DROP CONSTRAINT "category_entry_token_idx"`);
        await queryRunner.query(`CREATE TYPE "public"."category_enum_old" AS ENUM('united_nations', 'politics', 'religion', 'celebrities', 'athletes', 'corporations', 'executives', 'dogs', 'cats', 'media', 'sports', 'influencers')`);
